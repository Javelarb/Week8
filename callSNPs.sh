...
# merge lanes within samples this is an incredible useful shell trick you wouldn't learn for a few years = $(printf 'I=%s ' ${prefix}*.RG.bam) 
#what is it doing?
...
## no recalibration unless dealing with human data (low SNP density, many HQ known SNPs) call genotype on each sample
